    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.penjualan.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.penjualan.inputs.no_faktur')
                            </th>
                            <th class="text-left">
                                @lang('crud.penjualan.inputs.tanggal_faktur')
                            </th>
                            <th class="text-right">
                                @lang('crud.penjualan.inputs.total_bayar')
                            </th>
                            <th class="text-left">
                                @lang('crud.penjualan.inputs.pelanggan_id')
                            </th>
                            <th class="text-left">
                                @lang('crud.penjualan.inputs.user_id')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $penjualan->tanggal_faktur ?? '-' }}</td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">{!! $penjualans->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
